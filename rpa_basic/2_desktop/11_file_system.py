# 파일 기본
import os
# print(os.getcwd()) # cureent working directory 현재 작업 공간
...
# 파일 경로에서 폴더 정보 가져오기
# print(os.path.dirname(r"C:\Users\gaonsoft\Desktop\pythonWorkspace\my_file.txt"))  # r 문자 그대로 읽겠다. 탈출문자 필요없음.
...
# 어떤 파일을 폴더 안에 새로운 파일 이르으로 복사하기
# 원본 경로, 대상 경로(변경된 파일명까지)
